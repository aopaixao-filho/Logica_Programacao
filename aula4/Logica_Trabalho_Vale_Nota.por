programa
{
    ...
    const inteiro POLTRONAS_POR_FILEIRA = 15 // 15 poltronas por fileira
    ...
    {
        escreva("\nMapa de Poltronas:\n")
        escreva("     ") // Espaço para alinhar as fileiras
        para (inteiro i = 0; i < FILEIRAS; i++) {
            escreva(letras_fileiras[i], " ") // Exibe as letras das fileiras na horizontal
        }
        escreva("\n")
        ...
        para (inteiro j = 0; j < POLTRONAS_POR_FILEIRA; j++) {
            se(j + 1 < 10){
            	escreva(j + 1, "    ")// Exibe o número da poltrona na vertical
            }senao {
            	escreva(j + 1, "   ")
            }
            para (inteiro i = 0; i < FILEIRAS; i++) {
